...
try:
    client = client.Client('wss://acdbgraph-dam.gremlin.cosmos.azure.com:443/', 'g',
                        username="/dbs/graphdb/colls/Persons",
                        password="3oUFQsO2yBFGazVNWpg7W9lMBtfIi2BQpXmzwoKGMWcFdmqKqflgYzjTRXLx03e8Fqu0p0zoUY92ACDbS8rqJw==",
